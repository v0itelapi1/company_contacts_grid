		...
		if ($this->entityID > 0)
		{
			if (!$this->isMyCompany())
			{
				if (!$this->arResult['CATEGORY_ID'])
				{
					...
					$this->arResult['TABS'][] = [
						'id' => 'tab_contact',
						'name' => Loc::getMessage('CRM_COMPANY_TAB_CONTACT'),
						'loader' => [
							'serviceUrl' => '/local/components/bitrix/crm.contact.list/lazyload.ajax.php?&site'
								. SITE_ID
								. '&'
								. bitrix_sessid_get(),
							'componentData' => [
								...
								'signedParameters' => \CCrmInstantEditorHelper::signComponentParams([
									'CONTACT_COUNT' => '20',
									'PATH_TO_CONTACT_SHOW' => $this->arResult['PATH_TO_CONTACT_SHOW'] ?? '',
									...
									'ENABLE_TOOLBAR' => true,
									'PRESERVE_HISTORY' => true,
									'ADD_EVENT_NAME' => 'CrmCreateContactFromCompany'
								], 'crm.contact.list')
							]
						]
					];
				...
				//print_r($this->entityData['UF_CRM_1707471779']['VALUE']);
				if (
